...
| 方案 | 代表 checkpoint | Overall | Spatial | Object | Goal | LIBERO-10 |
|---|---|---:|---:|---:|---:|---:|
| No Pooling | `step_028930` | `93.58` | `98.67` | `99.33` | `92.33` | `84.00` |
| View Patch `[1,2,2]` | `step_023000` | `88.67` | `94.00` | `99.00` | `88.33` | `73.33` |
