...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| No Pooling lr1e-5 from `028930` | `step_020000` | `96` | `16.91` | `94.92` | `96.67` | `99.33` | `97.00` | `86.67` |
| No Pooling lr1e-5 from `028930` | `step_022000` | `96` | `17.60` | `94.75` | `98.00` | `98.33` | `96.67` | `86.00` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | No Pooling lr1e-5 from `028930` | `step_020000` | `96` | `16.91` | `96.67` | `99.33` | `97.00` | `86.67` | `94.92` |
| 2 | No Pooling lr1e-5 from `028930` | `step_022000` | `96` | `17.60` | `98.00` | `98.33` | `96.67` | `86.00` | `94.75` |
| 3 | No Pooling lr1e-5 from `028930` | `step_016000` | `96` | `15.53` | `96.00` | `96.33` | `97.33` | `85.67` | `93.83` |
| 4 | DINO smallvideo framecache | `step_042000` | `64` | `9.68` | `96.67` | `99.33` | `95.33` | `83.00` | `93.58` |
| 4 | No Pooling fixed finetune from `028930` | `step_004000` | `96` | `11.38` | `96.67` | `99.67` | `95.67` | `82.33` | `93.58` |
| 4 | No Pooling fresh | `step_028930` | `96` | `10.00` | `98.67` | `99.33` | `92.33` | `84.00` | `93.58` |
| 7 | DINO smallvideo lv1 from `040000` | `step_052000` | `128` | `23.96` | `98.33` | `99.00` | `92.33` | `84.33` | `93.50` |
| 8 | No Pooling lr1e-5 from `028930` | `step_008000` | `96` | `12.77` | `96.67` | `98.67` | `93.33` | `84.67` | `93.33` |
| 8 | No Pooling lr1e-5 from `028930` | `step_004000` | `96` | `11.38` | `97.67` | `99.33` | `97.00` | `79.33` | `93.33` |
| 10 | DINO smallvideo framecache | `step_040000` | `64` | `9.22` | `96.00` | `98.33` | `93.33` | `85.33` | `93.25` |
| 11 | DINO smallvideo framecache | `step_038000` | `64` | `8.76` | `98.00` | `100.00` | `93.00` | `81.00` | `93.00` |
| 11 | No Pooling fresh | `step_026000` | `96` | `8.99` | `96.67` | `99.67` | `92.33` | `83.33` | `93.00` |
| 13 | DINO smallvideo framecache | `step_043400` | `64` | `10.00` | `95.67` | `99.00` | `94.67` | `82.00` | `92.83` |
| 14 | No Pooling lr1e-5 from `028930` | `step_012000` | `96` | `14.15` | `96.67` | `98.67` | `95.33` | `80.00` | `92.67` |
| 15 | View Patch `[1,2,2]` full resume | `step_032000` | `128` | `14.75` | `95.00` | `98.33` | `96.33` | `77.33` | `91.75` |
| 16 | FastWAM VAE smallvideo | `step_021700` | `256` | `20.00` | `92.00` | `98.00` | `94.00` | `81.33` | `91.33` |
| 17 | View Patch `[1,1,2]` lr2e-5 from `024000` | `step_020000` | `96` | `15.21` | `93.00` | `100.00` | `96.67` | `74.33` | `91.00` |
| 17 | FastWAM VAE smallvideo lr1e-5 from `021700` | `step_002000` | `256` | `21.84` | `89.67` | `97.67` | `95.00` | `81.67` | `91.00` |
| 19 | View Patch `[1,2,2]` weightonly from `032000` | `step_008000` | `128` | `18.43` | `93.67` | `98.00` | `94.00` | `75.00` | `90.17` |
| 19 | FastWAM VAE smallvideo | `step_020000` | `256` | `18.43` | `91.33` | `97.00` | `94.00` | `78.33` | `90.17` |
| 21 | FastWAM VAE smallvideo lr1e-5 from `021700` | `step_004000` | `256` | `23.69` | `89.67` | `97.67` | `93.00` | `79.67` | `90.00` |
| 22 | FastWAM VAE smallvideo | `step_018000` | `256` | `16.59` | `90.00` | `97.67` | `94.67` | `76.67` | `89.75` |
| 23 | FastWAM VAE smallvideo lr1e-5 from `021700` | `step_005425` | `256` | `25.00` | `89.67` | `97.00` | `93.33` | `78.67` | `89.67` |
| 24 | View Patch `[1,2,2]` weightonly from `032000` | `step_014000` | `128` | `21.20` | `92.67` | `95.67` | `95.33` | `74.00` | `89.42` |
| 25 | FastWAM VAE smallvideo | `step_014000` | `256` | `12.90` | `87.67` | `98.00` | `92.33` | `76.67` | `88.67` |
| 25 | View Patch `[1,2,2]` | `step_023000` | `128` | `10.60` | `94.00` | `99.00` | `88.33` | `73.33` | `88.67` |
| 27 | View Patch `[1,1,2]` | `step_024000` | `96` | `8.30` | `95.67` | `98.00` | `87.67` | `72.33` | `88.42` |
| 28 | View Patch `[1,2,2]` merged-token loss | `step_021700` | `128` | `10.00` | `95.67` | `98.33` | `86.33` | `64.67` | `86.25` |
