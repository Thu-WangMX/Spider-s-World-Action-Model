...
| 10 | No Pooling lr1e-5 from `028930` | `step_016000` | `96` | `15.53` | `96.00` | `96.33` | `97.33` | `85.67` | `93.83` |
| 11 | Avg Pooling lr1e-5 from `043400` 10ep base | `step_010000` | `128` | `14.61` | `97.67` | `96.67` | `93.67` | `87.00` | `93.75` |
| 12 | DINO smallvideo framecache | `step_042000` | `64` | `9.68` | `96.67` | `99.33` | `95.33` | `83.00` | `93.58` |
| 12 | No Pooling fixed finetune from `028930` | `step_004000` | `96` | `11.38` | `96.67` | `99.67` | `95.67` | `82.33` | `93.58` |
| 12 | No Pooling fresh | `step_028930` | `96` | `10.00` | `98.67` | `99.33` | `92.33` | `84.00` | `93.58` |
| 15 | DINO smallvideo lv1 from `040000` | `step_052000` | `128` | `23.96` | `98.33` | `99.00` | `92.33` | `84.33` | `93.50` |
| 15 | Avg Pooling lr1e-5 from `043400` 10ep base | `step_021000` | `128` | `19.68` | `93.67` | `97.00` | `97.00` | `86.33` | `93.50` |
| 17 | No Pooling lr1e-5 from `028930` | `step_008000` | `96` | `12.77` | `96.67` | `98.67` | `93.33` | `84.67` | `93.33` |
| 17 | No Pooling lr1e-5 from `028930` | `step_004000` | `96` | `11.38` | `97.67` | `99.33` | `97.00` | `79.33` | `93.33` |
| 19 | DINO smallvideo framecache | `step_040000` | `64` | `9.22` | `96.00` | `98.33` | `93.33` | `85.33` | `93.25` |
| 20 | DINO smallvideo framecache | `step_038000` | `64` | `8.76` | `98.00` | `100.00` | `93.00` | `81.00` | `93.00` |
| 20 | No Pooling fresh | `step_026000` | `96` | `8.99` | `96.67` | `99.67` | `92.33` | `83.33` | `93.00` |
| 22 | DINO smallvideo framecache | `step_043400` | `64` | `10.00` | `95.67` | `99.00` | `94.67` | `82.00` | `92.83` |
| 23 | No Pooling lr1e-5 from `028930` | `step_012000` | `96` | `14.15` | `96.67` | `98.67` | `95.33` | `80.00` | `92.67` |
| 24 | View Patch `[1,2,2]` full resume | `step_032000` | `128` | `14.75` | `95.00` | `98.33` | `96.33` | `77.33` | `91.75` |
| 25 | FastWAM VAE smallvideo | `step_021700` | `256` | `20.00` | `92.00` | `98.00` | `94.00` | `81.33` | `91.33` |
| 26 | View Patch `[1,1,2]` lr2e-5 from `024000` | `step_020000` | `96` | `15.21` | `93.00` | `100.00` | `96.67` | `74.33` | `91.00` |
| 26 | FastWAM VAE smallvideo lr1e-5 from `021700` | `step_002000` | `256` | `21.84` | `89.67` | `97.67` | `95.00` | `81.67` | `91.00` |
| 28 | View Patch `[1,2,2]` weightonly from `032000` | `step_008000` | `128` | `18.43` | `93.67` | `98.00` | `94.00` | `75.00` | `90.17` |
| 28 | FastWAM VAE smallvideo | `step_020000` | `256` | `18.43` | `91.33` | `97.00` | `94.00` | `78.33` | `90.17` |
| 30 | FastWAM VAE smallvideo lr1e-5 from `021700` | `step_004000` | `256` | `23.69` | `89.67` | `97.67` | `93.00` | `79.67` | `90.00` |

说明：完整 leaderboard 已更新到 `libero_dashboard/dashboard_data.json`，当前共 `54` 个 eval。VAE loss-aligned `0.05/5.0` 不在 top 30 内，best 为 `step_054000`，`76.08 Overall / 54.67 LIBERO-10`；20ep endpoint `step_057860` 为 `75.83 Overall / 53.67 LIBERO-10`。这批结果支持“DINO 优势不是简单由 loss 权重造成”的结论。
